    ...
    <>
      ...
      <section id="inicio" className="hero-bg min-h-screen flex items-center justify-center relative overflow-hidden">
        ...
        <div className="relative z-10 text-center max-w-5xl mx-auto px-6 pt-24 pb-16">
          <div className="inline-flex items-center gap-2 bg-[rgba(212,168,67,0.1)] border border-[rgba(212,168,67,0.3)] rounded-full px-4 py-2 mb-8">
      ...
      <section id="sobre" className="py-24 bg-[#130f0a] relative overflow-hidden">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="animate-on-scroll mt-16 flex justify-center" style={{animationDelay:'0.3s'}}>
            <div className="relative rounded-2xl overflow-hidden border border-[rgba(212,168,67,0.2)]" style={{aspectRatio:'9/16', maxWidth:280, width:'100%'}}>
              <video
      ...
      <section id="servicos" className="py-24 bg-[#0a0806] relative">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {servicos.map((s, i) => (
              <div key={i} className="animate-on-scroll card-glass rounded-2xl p-6 hover:border-[rgba(212,168,67,0.4)] transition-all duration-300 group" style={{animationDelay:`${i*0.1}s`}}>
      ...
      <section className="py-16 bg-[#0d0a07]">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-12 animate-on-scroll">
            <div className="inline-block bg-[rgba(212,168,67,0.1)] border border-[rgba(212,168,67,0.25)] rounded-full px-4 py-1.5 mb-4">
              <span className="text-[#d4a843] text-xs font-semibold tracking-widest uppercase">Explore Nossos Servicos</span>
            </div>
            <h2 className="font-display font-bold text-3xl md:text-4xl text-white mb-4">Tudo que Voce Precisa em <span className="gold-text">Um So Lugar</span></h2>
            <p className="text-gray-400 max-w-xl mx-auto">Cobertura completa para seu evento em Umuarama PR.</p>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <a href="/servicos" className="animate-on-scroll group block rounded-2xl p-6 text-center border border-[rgba(212,168,67,0.3)] bg-[rgba(212,168,67,0.08)] transition-all duration-300 hover:-translate-y-2">
              <div className="text-5xl mb-4 group-hover:scale-110 transition-transform duration-300">📱</div>
              <h3 className="font-bold text-white text-lg mb-2">Story Maker</h3>
              <p className="text-gray-400 text-xs leading-relaxed mb-4">Stories e Reels ao vivo durante o evento</p>
              <div className="inline-block text-xs font-bold px-3 py-1 rounded-full text-[#d4a843] bg-[rgba(212,168,67,0.15)] border border-[rgba(212,168,67,0.4)]">Ver mais</div>
            </a>
            <a href="/videomaker" className="animate-on-scroll group block rounded-2xl p-6 text-center border border-[rgba(220,80,80,0.3)] bg-[rgba(220,80,80,0.08)] transition-all duration-300 hover:-translate-y-2" style={{animationDelay:'0.1s'}}>
              <div className="text-5xl mb-4 group-hover:scale-110 transition-transform duration-300">🎬</div>
              <h3 className="font-bold text-white text-lg mb-2">Videomaker</h3>
              <p className="text-gray-400 text-xs leading-relaxed mb-4">Filmagem profissional e edicao criativa</p>
              <div className="inline-block text-xs font-bold px-3 py-1 rounded-full text-[#e05050] bg-[rgba(220,80,80,0.15)] border border-[rgba(220,80,80,0.4)]">Ver mais</div>
            </a>
            <a href="/fotografo" className="animate-on-scroll group block rounded-2xl p-6 text-center border border-[rgba(80,160,220,0.3)] bg-[rgba(80,160,220,0.08)] transition-all duration-300 hover:-translate-y-2" style={{animationDelay:'0.2s'}}>
              <div className="text-5xl mb-4 group-hover:scale-110 transition-transform duration-300">📷</div>
              <h3 className="font-bold text-white text-lg mb-2">Fotografo</h3>
              <p className="text-gray-400 text-xs leading-relaxed mb-4">40 anos de experiencia em Umuarama PR</p>
              <div className="inline-block text-xs font-bold px-3 py-1 rounded-full text-[#50a0e0] bg-[rgba(80,160,220,0.15)] border border-[rgba(80,160,220,0.4)]">Ver mais</div>
            </a>
            <a href="/blog" className="animate-on-scroll group block rounded-2xl p-6 text-center border border-[rgba(80,220,160,0.3)] bg-[rgba(80,220,160,0.08)] transition-all duration-300 hover:-translate-y-2" style={{animationDelay:'0.3s'}}>
              <div className="text-5xl mb-4 group-hover:scale-110 transition-transform duration-300">📝</div>
              <h3 className="font-bold text-white text-lg mb-2">Blog</h3>
              <p className="text-gray-400 text-xs leading-relaxed mb-4">Dicas e guias sobre eventos em Umuarama</p>
              <div className="inline-block text-xs font-bold px-3 py-1 rounded-full text-[#50e0a0] bg-[rgba(80,220,160,0.15)] border border-[rgba(80,220,160,0.4)]">Ver mais</div>
            </a>
          </div>
        </div>
      </section>
      ...
      {/* ── INSTAGRAM BANNER ────────────────────────────── */}
      <section className="py-12 bg-[#0a0806]">
        <div className="max-w-5xl mx-auto px-6">
          <a href="https://www.instagram.com/giroto_storymaker/" target="_blank" rel="noopener noreferrer"
            className="animate-on-scroll block rounded-3xl overflow-hidden relative group cursor-pointer"
            style={{background:'linear-gradient(135deg, #833ab4 0%, #fd1d1d 40%, #fcb045 100%)'}}>
            <div className="absolute inset-0 opacity-20" style={{backgroundImage:"url('/fotos/foto5.jpg')", backgroundSize:'cover', backgroundPosition:'center'}} />
            <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6 p-8 md:p-12">
              <div className="flex items-center gap-6">
                <div style={{width:72,height:72,borderRadius:'50%',border:'3px solid #fff',overflow:'hidden',flexShrink:0}}>
                  <img src="/fotos/foto5.jpg" alt="Giroto Story Maker Instagram" style={{width:'100%',height:'100%',objectFit:'cover'}} />
                </div>
                <div>
                  <div className="text-white font-black text-2xl md:text-3xl">@giroto_storymaker</div>
                  <div className="text-white/80 text-sm mt-1">Story Maker Profissional em Umuarama PR</div>
                  <div className="flex items-center gap-2 mt-2">
                    <span className="text-white/90 text-xs">✨ Casamentos</span>
                    <span className="text-white/60">•</span>
                    <span className="text-white/90 text-xs">🎓 Formaturas</span>
                    <span className="text-white/60">•</span>
                    <span className="text-white/90 text-xs">🎉 Eventos</span>
                  </div>
                </div>
              </div>
              <div className="flex flex-col items-center gap-3">
                <div style={{background:'#fff',color:'#833ab4',padding:'12px 28px',borderRadius:30,fontWeight:800,fontSize:15,display:'flex',alignItems:'center',gap:8,whiteSpace:'nowrap'}} className="group-hover:scale-105 transition-transform">
                  <svg width="20" height="20" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2.163c3.204 0 3.584.012 4.85.07 3.252.148 4.771 1.691 4.919 4.919.058 1.265.069 1.645.069 4.849 0 3.205-.012 3.584-.069 4.849-.149 3.225-1.664 4.771-4.919 4.919-1.266.058-1.644.07-4.85.07-3.204 0-3.584-.012-4.849-.07-3.26-.149-4.771-1.699-4.919-4.92-.058-1.265-.07-1.644-.07-4.849 0-3.204.013-3.583.07-4.849.149-3.227 1.664-4.771 4.919-4.919 1.266-.057 1.645-.069 4.849-.069zm0-2.163c-3.259 0-3.667.014-4.947.072-4.358.2-6.78 2.618-6.98 6.98-.059 1.281-.073 1.689-.073 4.948 0 3.259.014 3.668.072 4.948.2 4.358 2.618 6.78 6.98 6.98 1.281.058 1.689.072 4.948.072 3.259 0 3.668-.014 4.948-.072 4.354-.2 6.782-2.618 6.979-6.98.059-1.28.073-1.689.073-4.948 0-3.259-.014-3.667-.072-4.947-.196-4.354-2.617-6.78-6.979-6.98-1.281-.059-1.69-.073-4.949-.073zm0 5.838c-3.403 0-6.162 2.759-6.162 6.162s2.759 6.163 6.162 6.163 6.162-2.759 6.162-6.163c0-3.403-2.759-6.162-6.162-6.162zm0 10.162c-2.209 0-4-1.79-4-4 0-2.209 1.791-4 4-4s4 1.791 4 4c0 2.21-1.791 4-4 4zm6.406-11.845c-.796 0-1.441.645-1.441 1.44s.645 1.44 1.441 1.44c.795 0 1.439-.645 1.439-1.44s-.644-1.44-1.439-1.44z"/></svg>
                  Seguir no Instagram
                </div>
                <div className="text-white/70 text-xs">Veja os bastidores dos eventos ao vivo!</div>
                <a href="https://www.tiktok.com/@girotostorymaker" target="_blank" rel="noopener noreferrer"
                  style={{background:'#000',color:'#fff',padding:'10px 24px',borderRadius:30,fontWeight:800,fontSize:14,display:'flex',alignItems:'center',gap:8,whiteSpace:'nowrap',marginTop:4}}>
                ...
                <a href="https://www.facebook.com/people/Giroto-Story-Maker/61571625703393/" target="_blank" rel="noopener noreferrer"
                  style={{background:'#1877f2',color:'#fff',padding:'10px 24px',borderRadius:30,fontWeight:800,fontSize:14,display:'flex',alignItems:'center',gap:8,whiteSpace:'nowrap',marginTop:4}}>
      ...
      {/* MEGA FOOTER */}
      <footer className="bg-[#050403] border-t border-[rgba(212,168,67,0.15)]">
        <div className="max-w-6xl mx-auto px-6 py-16">
          <div className="grid grid-cols-2 md:grid-cols-5 gap-8 mb-12">
            <div className="col-span-2 md:col-span-1">
              <div className="flex items-center gap-3 mb-4">
                <div style={{width:44,height:44,borderRadius:'50%',background:'linear-gradient(135deg,#f0d080,#d4a843)',display:'flex',alignItems:'center',justifyContent:'center',fontWeight:900,color:'#0a0806',fontSize:18}}>G</div>
                <div><div className="text-white font-bold text-sm">Giroto</div><div className="text-[#d4a843] text-xs tracking-widest">STORY MAKER</div></div>
              </div>
              <p className="text-gray-500 text-xs leading-relaxed mb-4">Story Maker, Videomaker e Fotografo profissional em Umuarama PR.</p>
              <div className="flex gap-3">
                <a href="https://www.instagram.com/giroto_storymaker/" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full flex items-center justify-center text-sm hover:scale-110 transition-transform" style={{background:'linear-gradient(135deg,#833ab4,#fd1d1d,#fcb045)'}}>📸</a>
                <a href="https://www.tiktok.com/@girotostorymaker" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full bg-black flex items-center justify-center text-sm hover:scale-110 transition-transform">🎵</a>
                <a href="https://www.facebook.com/people/Giroto-Story-Maker/61571625703393/" target="_blank" rel="noopener noreferrer" className="w-8 h-8 rounded-full flex items-center justify-center text-sm hover:scale-110 transition-transform" style={{background:'#1877f2'}}>👤</a>
              </div>
            </div>
            <div>
              <h4 className="text-[#d4a843] font-bold text-sm mb-4">📱 Story Maker</h4>
              <ul className="space-y-2">
                {[['Casamento','/servicos/story-maker-para-casamento-em-umuarama-pr'],['Formatura','/servicos/story-maker-para-formatura-em-umuarama-pr'],['Festa 15 Anos','/servicos/story-maker-para-festa-de-15-anos-em-umuarama-pr'],['Aniversario','/servicos/story-maker-para-aniversario-em-umuarama-pr'],['Cha de Bebe','/servicos/story-maker-para-cha-de-bebe-em-umuarama-pr'],['Ver todos','/servicos']].map(([l,h]) => (
                  <li key={l}><a href={h} className="text-gray-500 hover:text-[#d4a843] text-xs transition-colors">{l}</a></li>
                ))}
              </ul>
            </div>
            <div>
              <h4 className="text-[#e05050] font-bold text-sm mb-4">🎬 Videomaker</h4>
              <ul className="space-y-2">
                {[['Casamento','/videomaker/videomaker-para-casamento-em-umuarama-pr'],['Filmagem','/videomaker/filmagem-de-casamento-em-umuarama-pr'],['Video Profissional','/videomaker/video-de-casamento-em-umuarama-pr'],['Reels','/videomaker/reels-de-casamento-em-umuarama-pr'],['Formatura','/videomaker/videomaker-para-formatura-em-umuarama-pr'],['Ver todos','/videomaker']].map(([l,h]) => (
                  <li key={l}><a href={h} className="text-gray-500 hover:text-[#e05050] text-xs transition-colors">{l}</a></li>
                ))}
              </ul>
            </div>
            <div>
              <h4 className="text-[#50a0e0] font-bold text-sm mb-4">📷 Fotografo</h4>
              <ul className="space-y-2">
                {[['Casamento','/fotografo/fotografo-para-casamento-em-umuarama-pr'],['Studio Foto Danielle','/fotografo'],['Formatura','/fotografo/fotografo-para-formatura-em-umuarama-pr'],['Book Fotografico','/fotografo/book-fotografico-em-umuarama-pr'],['Ensaio Casal','/fotografo/ensaio-externo-casal-em-umuarama-pr'],['Ver todos','/fotografo']].map(([l,h]) => (
                  <li key={l}><a href={h} className="text-gray-500 hover:text-[#50a0e0] text-xs transition-colors">{l}</a></li>
                ))}
              </ul>
            </div>
            <div>
            ...
            <div>
              ...
              <ul className="space-y-2 mb-4">
                {[['Story Maker Casamento','/blog/story-maker-para-casamento-em-umuarama-pr'],['Fotografo Casamento','/blog/fotografo-de-casamento-em-umuarama-pr'],['Videomaker','/blog/videomaker-para-casamento-em-umuarama-pr'],['Ver todos','/blog']].map(([l,h]) => (
                  <li key={l}><a href={h} className="text-gray-500 hover:text-[#50e0a0] text-xs transition-colors">{l}</a></li>
                ))}
              </ul>
              <p className="text-xs text-gray-500 mb-1">💬 (44) 98438-3013</p>
              <p className="text-xs text-gray-600 leading-relaxed">📍 Rua Amadeu Boggio Melo, 925 - Jd. Alto da Boa Vista, Umuarama PR</p>
            </div>
          </div>
          <div className="border-t border-[rgba(212,168,67,0.1)] pt-8 flex flex-col md:flex-row items-center justify-between gap-4">
